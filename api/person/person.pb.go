...
var file_person_person_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x1a, 0x1f, 0x67,
	...
	0x61, 0x69, 0x6c, 0x12, 0x32, 0x0a, 0x06, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x50, 0x65, 0x72,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x1a, 0x53, 0x0a, 0x0b, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2c, 0x0a,
	...
	0x0a, 0x04, 0x57, 0x4f, 0x52, 0x4b, 0x10, 0x02, 0x22, 0x35, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x26, 0x0a, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c,
	0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e,
	...
	,
}
...
var file_person_person_proto_goTypes = []interface{}{
	...
	(*Id)(nil),                  // 3: person.Id
	(*Empty)(nil),               // 4: person.Empty
	(*Person_PhoneNumber)(nil),  // 5: person.Person.PhoneNumber
	(*timestamp.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_person_person_proto_depIdxs = []int32{
	5, // 0: person.Person.phones:type_name -> person.Person.PhoneNumber
	6, // 1: person.Person.last_updated:type_name -> google.protobuf.Timestamp
	...
	1, // 4: person.PersonService.createUser:input_type -> person.Person
	4, // 5: person.PersonService.getUsers:input_type -> person.Empty
	3, // 6: person.PersonService.createUser:output_type -> person.Id
	2, // 7: person.PersonService.getUsers:output_type -> person.AddressBook
...
type PersonServiceClient interface {
	CreateUser(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Id, error)
	GetUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AddressBook, error)
}
...
func (c *personServiceClient) CreateUser(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Id, error) {
	out := new(Id)
	err := c.cc.Invoke(ctx, "/person.PersonService/createUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *personServiceClient) GetUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AddressBook, error) {
	out := new(AddressBook)
	err := c.cc.Invoke(ctx, "/person.PersonService/getUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PersonServiceServer interface {
	CreateUser(context.Context, *Person) (*Id, error)
	GetUsers(context.Context, *Empty) (*AddressBook, error)
}
...
func (*UnimplementedPersonServiceServer) CreateUser(context.Context, *Person) (*Id, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (*UnimplementedPersonServiceServer) GetUsers(context.Context, *Empty) (*AddressBook, error) {
...
func _PersonService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Person)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServiceServer).CreateUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/person.PersonService/CreateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).CreateUser(ctx, req.(*Person))
	}
	return interceptor(ctx, in, info, handler)
}

func _PersonService_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServiceServer).GetUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/person.PersonService/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).GetUsers(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PersonService_CreateUser_Handler,
		},
		{
			MethodName: "getUsers",
			Handler:    _PersonService_GetUsers_Handler,
		},
	},
